        ...
        <div id="wrapper">
            ...
            <div class="left side-menu">
                ...
                <div class="sidebar-user">
                    <img src="{{ asset('/images/users/avatar-6.jpg') }}" alt="user" class="rounded-circle img-thumbnail mb-1">
                            ...
                            <ul class="list-inline float-right mb-0">
                                ...
                                <li class="list-inline-item dropdown notification-list hide-phone">
                                    <a class="nav-link dropdown-toggle arrow-none waves-effect text-white" data-toggle="dropdown" href="#" role="button"
                                        ...
                                        English <img src="{{ asset('/images/flags/us_flag.jpg') }}" class="ml-2" height="16" alt=""/>
                                    </a>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td class="border-top-0">
                                                                <div class="media">
                                                                    <img src="{{ asset('/images/users/avatar-2.jpg') }}" alt="" class="thumb-md rounded-circle"> 
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="media">
                                                                    <img src="{{ asset('/images/users/avatar-3.jpg') }}" alt="" class="thumb-md rounded-circle"> 
                                                                    <div class="media-body ml-2">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="media">
                                                                    <img src="{{ asset('/images/users/avatar-4.jpg') }}" alt="" class="thumb-md rounded-circle"> 
                                                                    <div class="media-body ml-2">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="media">
                                                                    <img src="{{ asset('/images/users/avatar-5.jpg') }}" alt="" class="thumb-md rounded-circle"> 
                                                                    <div class="media-body ml-2">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="d-sm-flex align-self-center">
                                                    <img src="{{ asset('/images/widgets/code.svg') }}" alt="" class="" height="100">
                                                ...
                                                <table class="table table-hover mb-0">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <img src="{{ asset('/images/users/avatar-1.jpg') }}" alt="" class="thumb-sm rounded-circle mr-2">
                                                                Kevin Heal
                                                            </td>
                                                            <td>Paypal</td>
                                                            <td>5/8/2018</td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <img src="{{ asset('/images/users/avatar-2.jpg') }}" alt="" class="thumb-sm rounded-circle mr-2">
                                                                Frank M. Lyons
                                                            </td>
                                                            <td>Paypal</td>
                                                            <td>15/7/2018</td> 
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <img src="{{ asset('/images/users/avatar-3.jpg') }}" alt="" class="thumb-sm rounded-circle mr-2">
                                                                Angelo Butler
                                                            </td>
                                                            <td>Pioneer</td>
                                                            <td>30/9/2018</td>                                                                        
                                                        ...
                                                        <tr>
                                                            <td>Website &amp; Blog</td>
                                                            <td>
                                                                <img src="{{ asset("/images/users/avatar-4.jpg") }}" alt="" class="thumb-sm rounded-circle mr-2">
                                                                Phillip Morse
                                                            </td>
                                                            <td>Paypal</td>
                                                            <td>2/6/2018</td>
                                                        ...
                                                        <tr>
                                                            <td>Product Devlopment</td>
                                                            <td>
                                                                <img src="{{ asset('/images/users/avatar-5.jpg') }}" alt="" class="thumb-sm rounded-circle mr-2">
                                                                Kevin Heal
                                                            </td>
                                                            <td>Paypal</td>
                                                            <td>5/8/2018</td>
                                                        ...
                                                        <tr>
                                                            <td>New Office Building</td>
                                                            <td>
                                                                <img src="/images/users/avatar-6.jpg" alt="" class="thumb-sm rounded-circle mr-2">
                                                                Frank M. Lyons
                                                            </td>
                                                            <td>Paypal</td>
                                                            <td>15/7/2018</td> 
